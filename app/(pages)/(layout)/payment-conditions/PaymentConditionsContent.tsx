...
export default function PaymentConditionsContent() {
    ...
    return (
        <div className="payment-conditions-page">
            <h1>{cmsData?.title || 'Payment Conditions'}</h1>
            <div
                className="payment-conditions-content"
