...
import checkImage2 from '@/public/images/cart-img-2.png';
import checkImage3 from '@/public/images/cart-img-3.png';
import checkImage4 from '@/public/images/cart-img-4.png';
import checkImage5 from '@/public/images/cart-img-5.png';

export default function Checkoutcreate() {
  // Renamed from CartPage to CartContent
  return (
    <>
      <div className="checkout-create-row">
        <div className="creat-pro">
          <Image src={checkImage1} alt="image" width={327} height={328} />
        </div>
        <div className="checkout-create-right">
          <div className="checkout-create-top">
            <div className="left-part">
              <h4>Lorem ipsum</h4>
              <div className="name">
                <span>Name: </span>Lorem - 01580
              </div>
            </div>
          ...
          <div className="cart-box-sub">
            <div className="car-box-inner">
              <div className="img">
                <Image src={checkImage2} alt="image" width={85} height={61} />
              </div>
            ...
            <div className="car-box-inner">
              <div className="img">
                <Image src={checkImage3} alt="image" width={85} height={61} />
              </div>
              <div className="box-sub">
                <h6>Neck:</h6>
                <span>Crew</span>
            ...
            <div className="car-box-inner">
              <div className="img">
                <Image src={checkImage4} alt="image" width={85} height={61} />
              </div>
              <div className="box-sub">
                <h6>Style:</h6>
                <span>Jumper</span>
            ...
            <div className="car-box-inner">
              <div className="img">
                <Image src={checkImage5} alt="image" width={85} height={61} />
              </div>
              <div className="box-sub">
                <h6>fitting:</h6>
                <span>Regular</span>
