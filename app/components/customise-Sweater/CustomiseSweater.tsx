...
import '@/app/styles/customise-Sweater.css';
import SweaterBanner from './Customise-Sweater-banner';
...
import SweaterSlider from './sweater-slider';
import Customisebreadcrumb from './Customise-breadcrumb';
